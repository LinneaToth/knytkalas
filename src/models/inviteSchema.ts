...
const inviteSchema = new mongoose.Schema({
    event: { occasion: String, id: { type: mongoose.Schema.Types.ObjectId, ref: "Event" } },
    invitee: { name: String, id: { type: mongoose.Schema.Types.ObjectId, ref: "User" } },
    invitedBy: { name: String, id: { type: mongoose.Schema.Types.ObjectId, ref: "User" } },
    status: {
